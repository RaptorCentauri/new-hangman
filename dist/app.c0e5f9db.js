...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"../node_modules/core-js/library/modules/es6.object.to-string.js":[function(require,module,exports) {
...
},{"./_classof":"../node_modules/core-js/library/modules/_classof.js","./_array-from-iterable":"../node_modules/core-js/library/modules/_array-from-iterable.js"}],"../node_modules/core-js/library/modules/es7.set.to-json.js":[function(require,module,exports) {
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var $export = require('./_export');
...
},{"./_export":"../node_modules/core-js/library/modules/_export.js"}],"../node_modules/core-js/library/modules/es7.set.of.js":[function(require,module,exports) {
...
},{"./_set-collection-from":"../node_modules/core-js/library/modules/_set-collection-from.js"}],"../node_modules/core-js/library/fn/set.js":[function(require,module,exports) {
...
},{"../modules/es6.object.to-string":"../node_modules/core-js/library/modules/es6.object.to-string.js","../modules/es6.string.iterator":"../node_modules/core-js/library/modules/es6.string.iterator.js","../modules/web.dom.iterable":"../node_modules/core-js/library/modules/web.dom.iterable.js","../modules/es6.set":"../node_modules/core-js/library/modules/es6.set.js","../modules/es7.set.to-json":"../node_modules/core-js/library/modules/es7.set.to-json.js","../modules/es7.set.of":"../node_modules/core-js/library/modules/es7.set.of.js","../modules/es7.set.from":"../node_modules/core-js/library/modules/es7.set.from.js","../modules/_core":"../node_modules/core-js/library/modules/_core.js"}],"../node_modules/babel-runtime/core-js/set.js":[function(require,module,exports) {
module.exports = { "default": require("core-js/library/fn/set"), __esModule: true };
},{"core-js/library/fn/set":"../node_modules/core-js/library/fn/set.js"}],"../node_modules/core-js/library/modules/es6.map.js":[function(require,module,exports) {
'use strict';
var strong = require('./_collection-strong');
var validate = require('./_validate-collection');
var MAP = 'Map';
...
},{"./_export":"../node_modules/core-js/library/modules/_export.js","./_collection-to-json":"../node_modules/core-js/library/modules/_collection-to-json.js"}],"../node_modules/core-js/library/modules/es7.map.of.js":[function(require,module,exports) {
// https://tc39.github.io/proposal-setmap-offrom/#sec-map.of
require('./_set-collection-of')('Map');

},{"./_set-collection-of":"../node_modules/core-js/library/modules/_set-collection-of.js"}],"../node_modules/core-js/library/modules/es7.map.from.js":[function(require,module,exports) {
...
var Hangman = function Hangman(words) {
  var _this = this;

  var lives = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 6;
  var blankChar = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '*';

  _classCallCheck(this, Hangman);

  this.initializeGame = function () {
    // this.setWrongLetters();
    _this.setCurrentWord();

    _this.createWordMap();

    _this.setNumberOfLettersToWin();

    _this.setBlankLetters();
  };

  this.setCurrentWord = function () {
    var currentWord = _this.words[Math.floor(Math.random() * _this.words.length)];

    _this.currentWord = currentWord;
  };

  this.createWordMap = function () {
    var wordMap = new _map.default();

    for (var i = 0; i < _this.currentWord.length; i++) {
      if (wordMap.has(_this.currentWord[i])) {
        var currentIndex = wordMap.get(_this.currentWord[i]);
        currentIndex.push(i);
        wordMap.set(_this.currentWord[i], currentIndex);
      } else {
        wordMap.set(_this.currentWord[i], [i]);
      }
    }

    _this.wordMap = wordMap; // console.log(this.wordMap);
  };

  this.checkForLetter = function (ltr) {
    if (_this.wordMap.has(ltr)) {
      console.log('YES');

      _this.updateBlanks(_this.wordMap.get(ltr));

      _this.neededToWin--;
    } else {
      console.log('NO');

      _this.wrongLetters.add(ltr);
    }

    _this.checkForGameOver();
  };

  this.setBlankLetters = function () {
    var blanks = new Array(_this.currentWord.length).fill(_this.blankChar);
    _this.blanks = blanks;
  ...
  this.displayBlanks = function () {
    _this.blankVisibles = _this.blanks.join(""); // console.log(this.displayBlanks);
  };

  this.updateBlanks = function (arr) {
    for (var i = 0; i < arr.length; i++) {
      _this.blanks[arr[i]] = _this.currentWord[arr[i]];
    }

    _this.displayBlanks();
  };

  this.setNumberOfLettersToWin = function () {
    _this.neededToWin = _this.wordMap.size;
  };

  this.checkForGameOver = function () {
    if (_this.lives === _this.wrongLetters.size) {
      console.log('you lose!');
    }

    if (_this.neededToWin === 0) {
      console.log('You win!');
    }
  };
  ...
  this.wrongLetters = new _set.default();
} // setWrongLetters = () =>{
...
var _default = Hangman; // let game = new Hangman(words);
// game.initializeGame();
//
// game.checkForLetter('k');

exports.default = _default;
},{"babel-runtime/core-js/set":"../node_modules/babel-runtime/core-js/set.js","babel-runtime/core-js/map":"../node_modules/babel-runtime/core-js/map.js"}],"app/index.js":[function(require,module,exports) {
"use strict";
...
var _game = _interopRequireDefault(require("./gameLogic/game.js"));
...
function (_React$Component) {
  ...
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.game = new _game.default(['red', 'yellow', 'blue', 'orange']), _this.state = {
      blankWord: '',
      wrongLetters: []
      ...
      if (/^[a-zA-Z]{1}$/.test(guess)) {
        console.log("".concat(guess, " is a letter"));

        _this.game.checkForLetter(event.key);

        _this.setState({
          blankWord: _this.game.blankVisibles
        });

        var wrongArr = _toConsumableArray(_this.game.wrongLetters.values());

        _this.setState({
          wrongLetters: wrongArr
        });
      } else {
        console.log("".concat(guess, " is not a letter"));
      }
    }, _temp));
  }
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      this.setState({
        blankWord: this.game.blankVisibles
      });
      console.log(this.game.blankVisibles); // console.log(this.state);
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "App"
      }, this.state.blankWord, _react.default.createElement("br", null), "WRONG: ", this.state.wrongLetters);
    }
  }]);
...
(0, _reactDom.render)(_react.default.createElement(App, null), window.document.getElementById('root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./gameLogic/game.js":"app/gameLogic/game.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/index.js"], null)
//# sourceMappingURL=/app.c0e5f9db.map